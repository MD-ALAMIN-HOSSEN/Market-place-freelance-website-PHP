...
INSERT INTO `job` (`Job_id`, `Category_id`, `User_id`, `Titel`, `Price`, `Delivery_date`, `Details`, `Skills`, `Post_dateTime`, `Job_file`, `Status`, `Category`) VALUES
(1, NULL, 1, 'web tec', 3, '0003-03-31', 'v', 'html,css,java', '2024-05-12 07:00:09', 'lab8.2.png', 'posted', 'web development'),
(4, NULL, 1, 'web tec', 12, '0004-04-04', 'app', 'html,css,java k', '2024-05-12 07:05:04', 'lab8.1.png', 'posted', 'app development');
...
CREATE TABLE `order_buyer` (
  ...
  `Working_with_seller_user_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user` (
  ...
  `Forgot_password_phrase` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user` (`User_id`, `Email`, `Password`, `Status_type`, `Forgot_password_phrase`) VALUES
(1, 'rifatul@gmail.com', '123', 'buyer', '1234'),
(2, 'alamin@gmail.com', '123', 'seller', '1234'),
(3, '', '', '', ''),
(4, '', '', '', '');
...
INSERT INTO `user_profile` (`User_profile_id`, `User_id`, `First_name`, `Last_name`, `Country`, `Date_of_birth`, `Gender`, `Profile_picture`, `About`, `Balance`) VALUES
(1, 1, 'rifatul', 'islam', 'bangladesh', '2024-05-21', 'male', NULL, NULL, NULL),
(2, 2, 'alamin', 'hossen', 'bangladesh', '2024-05-14', 'male', NULL, NULL, NULL);
...
ALTER TABLE `order_buyer`
  ...
  ADD KEY `Working_with_seller_user_id` (`Working_with_seller_user_id`);
...
ALTER TABLE `order_buyer`
  ...
  ADD CONSTRAINT `order_buyer_ibfk_2` FOREIGN KEY (`Working_with_seller_user_id`) REFERENCES `user` (`User_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `order_seller_job`
  ADD CONSTRAINT `order_seller_job_ibfk_1` FOREIGN KEY (`Order_Seller_id`) REFERENCES `order_seller` (`Order_seller_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
