...
<body>
        ...
        <h2>Order Buyer</h2>
        <a href="order_details_buyer_posted.php" class="card-link">
        <div class="card">
            <div class="card-left">
            ...
            <div class="card-right">
                ...
                <div > <a class="button-link2 space-around"  href="order_details_buyer_posted.php"> see more</a></div>
            </div>
        </div>
        </a>
